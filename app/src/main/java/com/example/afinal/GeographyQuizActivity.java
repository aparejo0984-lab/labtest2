...
public class GeographyQuizActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        questionsAnswerMap = Utils.getRandomGeographyQuestions(Constants.QUESTION_SHOWING);
        ...
        findViewById(R.id.btnNextQuestionLiteratureAndGeography).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                {
                    Toast.makeText(GeographyQuizActivity.this, "Answer cannot be empty", Toast.LENGTH_SHORT).show();
                    return;
                }

                RadioButton radioButton =  findViewById(radioGroup.getCheckedRadioButtonId());
                //check if correct answers matches with the user selected
                ...
                if (btnNext.getText().equals(getString(R.string.next))){
                    ...
                    Intent intentResult = new Intent(GeographyQuizActivity.this,FinalResultActivity.class);
